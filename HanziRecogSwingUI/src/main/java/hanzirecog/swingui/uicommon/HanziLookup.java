...
import hanzirecog.swingui.handwrittenHanziAnalyzer.CharacterCanvas;
import hanzirecog.swingui.handwrittenHanziAnalyzer.CharacterCanvas.StrokeEvent;
...
import hanzirecog.swingui.handwrittenHanziAnalyzer.JClickableList;
import hanzirecog.swingui.OnlineHanziRecog;
...
public class HanziLookup extends JPanel {
  ...
  public void registerLookupMacro(KeyStroke keyStroke) {
    ...
    final String LOOKUP_COMMAND_KEY = "hanzirecog.swingui.handwrittenHanziAnalyzer.lookup";
  ...
  public void registerClearMacro(KeyStroke keyStroke) {
    ...
    final String CLEAR_COMMAND_KEY = "hanzirecog.swingui.handwrittenHanziAnalyzer.clear";
  ...
  public void registerUndoMacro(KeyStroke keyStroke) {
    ...
    final String CLEAR_COMMAND_KEY = "hanzirecog.swingui.handwrittenHanziAnalyzer.undo";
