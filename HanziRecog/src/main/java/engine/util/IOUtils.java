 ...
 * @author jkiang
 *
 * Stroke recognizer is stored in byte arrays, and written and read via recognizer byte streams.
 * This class defines methods for reading recognizer from and writing recognizer to those streams.
 */
public class IOUtils {
    ...
    static public void writeCharacterType(CharacterType type, DataOutputStream out) throws IOException {
