...
import engine.beans.CharacterMatch;
import engine.service.datasource.MemoryStrokesStreamProvider;
import engine.service.datasource.StrokesDataSource;
import engine.util.CurveUtils;
import engine.beans.CharacterDescriptor;
import engine.util.PriorityList;
...
public class StrokesMatcher {
    ...
    static private final String DATA_PATH = "/engine/strokes.dat";
